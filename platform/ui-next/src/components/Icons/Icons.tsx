...
export const Icons = {
  mprDirect: (props: ImageIconProps) => (
    <ImageWrapper
      src={mprDirect}
      {...props}
    />
  ...
  logoNolex: (props: ImageIconProps) => (
    <ImageWrapper
      src={logoNolex}
      {...props}
    />
  ),
  hpIcon: (props: ImageIconProps) => (
    <ImageWrapper
      src={hpIcon}
      {...props}
    />
  ...
  'tool-referenceCursors': (props: IconProps) => ToolReferenceCursors(props),
