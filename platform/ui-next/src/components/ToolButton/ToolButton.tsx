...
const defaultClasses = 'bg-transparent text-foreground/80 hover:bg-background';
const activeClasses = 'bg-primary-light text-background';
const disabledClasses =
  'text-common-bright hover:bg-primary-dark opacity-40 cursor-not-allowed';
